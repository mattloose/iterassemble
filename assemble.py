...
def assemble (i, id, arr1, args):
    ...
    subprocess.call("ls "+args.d+"/seq*_R1.fastq | parallel -k 'cat {} | fqextract "+fids+"' > "+f1, shell=True)
    subprocess.call("ls "+args.d+"/seq*_R2.fastq | parallel -k 'cat {} | fqextract "+fids+"' > "+f2, shell=True)
